...
const About = () => {
    ...
    const milestones = [
        { year: 'OCT 2025', title: 'Founded', description: 'Bit Brainic was born with a vision to democratize CS education.' },
        { year: 'NOV 2025', title: 'Beta Launch', description: 'Released our first version to early adopters and gathered feedback.' },
        { year: 'DEC 2025', title: 'AI Integration', description: 'Integrated Google Gemini AI for enhanced tutoring capabilities.' },
        { year: 'JAN 2026', title: 'Public Launch', description: 'Officially launched to the public with improved features.' }
    ];
